...
var mergeTwoLists = function(l1, l2) {
    ...
    while(l1 && l2){  // while both l1 and l2 exist, select the smallest value from either linked list,
        if(l1.val < l2.val){
            dummy.next = l1
            l1 = l1.next
        } else {
        ...
        dummy = dummy.next  //then increment dummy node forward.
        console.log(dummy)
    }
